...
const AIChatPage: React.FC = () => {
  ...
  return (
    <div className="chatgpt-page flex">
      {/* Left Sidebar - Desktop */}
      <aside className="hidden md:flex md:flex-col md:w-64 lg:w-72 bg-[#1a1a1a] border-r border-[#2f2f2f] overflow-y-auto">
        <div className="p-4 border-b border-[#2f2f2f]">
          <h2 className="text-sm font-semibold text-gray-400 uppercase tracking-wider">Suggestions</h2>
        </div>
        <div className="flex flex-col gap-2 p-3">
          {promptTemplates.map((template) => (
            <button
              key={template}
              className="chip-sidebar"
              type="button"
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="composer-bar">
          <div className="composer-shell">
            ...
            <div className="md:hidden quick-row-mobile">
              {promptTemplates.map((template) => (
